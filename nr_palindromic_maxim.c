...
int main()
{
    ...
    for ( i = 1; i < 10; i++ )//in vectorul a pun pt fiecare nr (indice) de cate ori apare
     {
        a[i] = 0;
        for ( j = 0; j < n; j++)
        {
    ...
    if ((nr_cifre%2)!=0)//daca am nr impar de cifre
        {
            ...
            if(nr_impar_ori!=1)//daca nu am niciuna/am mai multe de nr impar ori, nu se poate face palindrom
                {
                    printf("0");
                    exit(0);
                }
                ...
                {
                    for ( i = 9; i > 0; i-- ) //afisez descrescator fiecare cifra de nr_aparitii/2 
                        {
                            if (a[i]!=0)
                             for ( j = 0; j < a[i]/2;j++)
                                 printf("%d", i);
                    ...
                    for ( i = 1; i < 10; i++ )//afisez crescator fiecare cifra de nr_aparitii/2 
                         {
